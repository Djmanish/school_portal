    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, null=True, related_name='user_permissions', to='main_app.App_functions')),
            ],
            options={
                'ordering': ['-level_id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_designation', to='main_app.Institute_levels')),
