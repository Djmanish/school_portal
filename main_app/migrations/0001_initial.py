# Generated by Django 3.0.8 on 2020-07-27 03:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dob_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])], verbose_name='Date of Birth Certificate')),
                ('id_proof_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('domicile_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('cast_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('character_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('medical_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('transfer_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('last_year_certificate', models.FileField(blank=True, null=True, upload_to='student_document', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
