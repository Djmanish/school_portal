...
class School_tags(models.Model):
    ...
    type= models.CharField(max_length=7, choices = [('','-- select one --'),('debit','debit'),('credit','credit')], null=True, default="")
    active = models.CharField(max_length=5, choices = [('','-- select one --'),('yes','yes'),('no','no')], null=True, default="")
