...
class ExamDetails(models.Model):
  ...
  exam_type=models.ForeignKey(to=ExamType, on_delete=models.CASCADE, related_name='exam_type_info', null=True)
  institute=models.ForeignKey(to=Institute, on_delete=models.CASCADE, related_name='examdetails_institute', null=True)
  exam_class=models.ForeignKey(to=Classes, on_delete=models.CASCADE, related_name='examdetails_class', null=True)
